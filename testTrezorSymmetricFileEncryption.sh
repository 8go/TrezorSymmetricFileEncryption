...
if [ $# -ge 1 ]; then
    ...
    echo "Step 12: Decrypting with safety check and wipe: " ./TrezorSymmetricFileEncryption.py -t  -d -s -w -p ${passphrase} "${encryptedfilearray[@]}"
    ...
    echo "Step 14: Decrypting with safety check and wipe: " ./TrezorSymmetricFileEncryption.py -t  -d -s -w -p ${passphrase} "${obfuscatedfilearray[@]}"
